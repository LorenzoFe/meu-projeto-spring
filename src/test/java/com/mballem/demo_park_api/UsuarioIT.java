...
public class UsuarioIT {
    ...
    @Test
    public void createUsuario_ComUsernameRepetido_ErrorMessageStatus409(){
        ErrorMessage responseBody = testClient
                .post()
                .uri("api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("lorenzo@gmail.com", "123456"))
                .exchange()
...
//                .uri("api/v1/usuarios/100")
//                .contentType(MediaType.APPLICATION_JSON)
//                .bodyValue(new UsuarioSenhaDto("123456", "123457", "000000"))
//                .exchange()
